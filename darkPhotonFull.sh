...
cd darkPhotonBuild2
rm -rf *
cmake -DGEANT4_BUILD_MULTITHREADED=OFF -DGeant4_DIR=/usr/local/geant4.10.00.p01/lib64/Geant4-10.0.0 -DHEPMC_INCLUDE_DIR=/media/sf_darkphotons/madgraph/hepmcbuild/include/ -DHEPMC_LIBRARIES=/media/sf_darkphotons/madgraph/hepmcbuild/lib/libHepMC.so ../darkPhoton2
