...
# don't erase the macro every time
mv /nfs/cms/mc1/cjc359/MMAPS/darkPhotonBuild2/runBatch.mac /nfs/cms/mc1/cjc359/MMAPS/
rm -rf darkPhotonBuild2/*
mv /nfs/cms/mc1/cjc359/MMAPS/runBatch.mac /nfs/cms/mc1/cjc359/MMAPS/darkPhotonBuild2
